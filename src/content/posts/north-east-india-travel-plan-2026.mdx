...
```mermaid
flowchart TD
    subgraph P1["📍 Phase 1 · D1–9 · Kolkata → Meghalaya"]
        KOL["1. Kolkata · D1\nDepart 6 AM · NH12 via Dankuni"]
        SIL["2. Siliguri · D1–2\nHill Cart Road momos dinner\nDooars and Himalayan foothills gateway"]
        GHY1["3. Guwahati · D2–4\nD3 city exploration stay day\nKamakhya Temple Shakti Peetha · Umananda Island golden langur\nBrahmaputra riverfront cruise · Assam State Museum\nApply ILP online eilp.arunachal.gov.in · D3"]
        SHL1["4. Shillong · D4–5 · sightseeing first visit\nD5 full exploration day\nShillong Peak 1965m IAF viewpoint panoramic\nElephant Falls 3-tier 12 km from city\nDon Bosco Museum 7 floors on all NE India\nWard's Lake colonial 1894 · Laitlum Canyon 24 km sunset"]
        CHR6["5a. Cherrapunji · D6 Waterfalls and Caves\nNohkalikai Falls 340m tallest plunge India\nSeven Sisters Falls 1033m wide 7 streams\nEco Park Bangladesh plains from cliff edge\nMawsmai Cave 150m lit limestone easiest"]
        CHR7["5b. Cherrapunji · D7 Hidden Spots\nArwah Cave 70 million yr fossils in walls\nWei Sawdong Falls 3-tier aquamarine pool swim\nGarden of Caves jungle stream trail\nDainthlen Falls serpent legend gorge"]
        CHR8["5c. Cherrapunji · D8 Root Bridge Trek\nTyrna village 3500 steps descent through jungle\nSingle Root Bridge en route to Nongriat\nDouble Decker Living Root Bridge 150 yr old\nNatural pools below Nongriat swim and rest"]
        DWK1["6. Dawki · D9 first visit\nUmngot River crystal clear riverbed 5m down glass boat\nShnongpdeng riverside camp campfire Bangladesh view\nCliff jumping guided 300 rs"]
        KOL --> SIL --> GHY1 --> SHL1 --> CHR6 --> CHR7 --> CHR8 --> DWK1
    end

    subgraph WFH_SEC["🖥 WFH Week · D10–14 · Shillong base"]
        SHL_WFH["WFH Base · Shillong · D10–14\nD10 early ride Dawki to Shillong done by 8 AM\nWork strictly 10 AM–6 PM · no riding at all\nHotel WiFi primary · Jio 4G/5G 20–80 Mbps backup\nPre-work rides before 10 AM:\nD11 Umiam Lake 15 km · D12 Shillong Peak 10 km\nD13 Elephant Falls 12 km · D14 Laitlum Canyon 24 km\nOpt any morning: Mawphlang Sacred Forest 25 km\nEvenings: Police Bazaar jadoh smoked pork\nDylan's Cafe live music · Iewduh Bazar Khasi market\nCafe Shillong Heritage British-era GS Road"]
    end

    subgraph W2_SEC["🌊 Weekend 2 · D15–16"]
        KRS["Krang Suri Falls · D15\nTurquoise pool jungle-surrounded entry 50 rs\nMost striking waterfall in Meghalaya"]
        DWK2["Dawki · D15 overnight again\nUmngot sunset coracle boat · Shnongpdeng camp"]
        JWI["Jowai · D16 en route to Guwahati\nFuel stop · Jaintia Hills HQ\nNartiang Monoliths 22 km optional\n100+ prehistoric menhirs Asia's largest menhir site\nThadlaskein Lake megalith rising from water"]
        GHY2["Guwahati · D16–17 return and depart\nCash withdrawal · confirm ILP · check docs"]
        KRS --> DWK2 --> JWI --> GHY2
    end

    subgraph TWG_SEC["🏔 Phase 3 · D17–22 · Tawang Circuit"]
        ...
        BHL["8. Bhalukpong · ILP gate · D18\nILP checkpoint register bike number and name\nKameng river confluence scenic\nLast plains-level fuel fill completely critical"]
        BOM1["9. Bomdila · D18 outward\nUpper Gontse Gang Monastery valley views\nApple orchards ripe October November\nopt Thembang Fortified Village 25 km off NH13"]
    ...
    SIL     -.->|"➕ +1–2d Sikkim"| ZUL(["➕ Zuluk Silk Route\nSikkim"])
    GHY1    -.->|"⚡ D17 +2hrs"| POB(["⚡ Pobitora WLS\nAssam"])
    GHY1    -.->|"➕ +1 day"| MAN(["➕ Manas NP UNESCO\nAssam"])
    SHL_WFH -.->|"⚡ WFH mornings"| MWP(["⚡ Mawphlang Forest\nMeghalaya"])
    CHR6    -.->|"⚡ D6 12km extra"| KYN(["⚡ Kynrem Falls\nMeghalaya"])
    JWI     -.->|"⚡ D16 22km"| NAR(["⚡ Nartiang Monoliths\nMeghalaya"])
    BOM1    -.->|"⚡ D18 25km"| THB(["⚡ Thembang Village\nArunachal P."])
    TWG_D20 -.->|"⚡ D20–21"| GNK(["⚡ Gongkar La\n~4500m AP"])
    TWG_D21 -.->|"⚡ D21"| ZEM(["⚡ Zemithang Valley\nArunachal P."])
    DBR     -.->|"⚡ D27 70km"| DIG(["⚡ Digboi +\nDehing Patkai"])
    ...
    classDef wfh  fill:#fb923c,stroke:#ea580c,color:#fff
    classDef opt  fill:#fef08a,stroke:#b45309,color:#1c1917
    classDef ext  fill:#e5e7eb,stroke:#6b7280,color:#374151

    class KOL,SIL wb
    class GHY1,TEZ,KZR,MAJ,SIV,DBR,GHY2 as
    class SHL1,CHR6,CHR7,CHR8,DWK1,JWI ml
    class BHL,BOM1,DIR,SEL,TWG_ARR,TWG_D20,TWG_D21,BOM2,ROI,MAY,ANI ap
    class SHL_WFH,KRS,DWK2 wfh
    class JLD,POB,MWP,KYN,NAR,THB,GNK,ZEM,DIG opt
    class ZUL,MAN ext
```

**Legend:** 🟢 West Bengal · 🔵 Assam · 🟣 Meghalaya · 🔴 Arunachal Pradesh · 🟠 WFH/weekend base · 🟡 ⚡ Optional easy add · ⬜ ➕ Requires extra days
