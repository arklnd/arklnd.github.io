...
```mermaid
flowchart LR
    %% ══ MAIN STOPS (overnight stays) ══════════════════════════════
    KOL["1. Kolkata\nD1 @ West Bengal > trip start"]
    SIL["2. Siliguri\nD1–2 @ West Bengal > overnight hub\nDooars gateway · momos"]
    GHY["3. Guwahati\nD2–4 @ Assam > city explore + apply ILP\nKamakhya · Umananda · Brahmaputra"]
    SHL["4. Shillong\nD4–5 @ Meghalaya > sightseeing\nD10–14 @ Meghalaya > WFH base 10AM–6PM\nShillong Peak · Elephant Falls · Don Bosco · Laitlum"]
    CHR["5. Cherrapunji\nD6–8 @ Meghalaya > waterfalls + caves + Root Bridge\nNohkalikai · Seven Sisters · Mawsmai · Arwah · Wei Sawdong"]
    DWK["6. Dawki\nD9 @ Meghalaya > Umngot river + camp\nD15 @ Meghalaya > post-WFH weekend\nShnongpdeng cliff jump · riverside camp"]
    TEZ["7. Tezpur\nD17 @ Assam > sightseeing\nAgnigarh Hill · Da Parbatia · Nameri NP buffer"]
    BHL["8. Bhalukpong · ILP check\nD18 @ Arunachal P. > ILP checkpoint + last plains fuel\nKameng river"]
    BOM["9. Bomdila\nD18 @ Arunachal P. > monasteries + orchards\nD22 @ Arunachal P. > return stopover\nGontse Gang monasteries · apple orchards"]
    DIR["10. Dirang\nD18 @ Arunachal P. > hot spring + Dzong + cranes\nSangti Valley cranes · Hot Spring · Dzong"]
    SEL["11. Sela Pass · 4170m\nD19 @ Arunachal P. > sacred lake + memorial + falls\nSela Lake · prayer flags · Jaswant Garh · Nuranang Falls"]
    TWG["12. Tawang\nD19–22 @ Arunachal P. > monastery + border + lakes\nMonastery · War Memorial · Madhuri Lake · PT Tso · Bum La"]
    KZR["13. Kaziranga NP\nD23–24 @ Assam > 3-range jeep safaris\nCentral · Eastern · Western range · rhino · tiger"]
    MAJ["14. Majuli\nD25–26 @ Assam > satra culture + island life\nKamalabari · Auniati satras · cycling · Brahmaputra sunrise"]
    SIV["15. Sivasagar\nD26 @ Assam > Ahom dynasty monuments\nRang Ghar · Talatal Ghar · Shiva Dol · Kareng Ghar"]
    DBR["16. Dibrugarh\nD26–27 @ Assam > Anini prep\nAnini supplies · cash · jerry can · offline maps"]
    ROI["17. Roing\nD27 @ Arunachal P. > Mehao Lake + last ATM\nroad conditions intel for Roing–Anini"]
    MAY["18. Mayudia · 2655m\nD28 @ Arunachal P. > forest pass\noak–rhododendron · CRPF post"]
    ANI["19. Anini\nD28–30 @ Arunachal P. > remote frontier\nDri River · Idu Mishmi · Dibang Wildlife Sanctuary"]

    %% ══ TRANSIT NODES (brief stops, no overnight) ═════════════════
    MWL["Mawlynnong\nD9 @ Meghalaya > Asia's Cleanest Village\nRiwai root bridge · bamboo skywalk"]
    KRS["Krang Suri\nD15 @ Meghalaya > turquoise waterfall\njungle swim"]
    JOR["Jorhat\nD25–26 @ Assam > ferry gateway\ntea city · Nimatighat access"]
    NIM["Nimatighat\nD25–26 @ Assam > Brahmaputra ferry ⛴️\ncrossing to Majuli"]

    %% ══ WFH DAILY ROUTINE NODES (D10–14) ══════════════════════════
    WFH_M["🚴 Morning rides\nD11–14 @ Meghalaya > before 10AM · one per day\nUmiam Lake · Shillong Peak · Elephant Falls or Mawphlang · Laitlum Canyon"]
    WFH_E["🚶 Evening walks\nD10–14 @ Meghalaya > after 6PM\nWard's Lake · Police Bazaar · Laitumkhrah · Iewduh Bazar"]
    ...
    MWL -->|"D9"| DWK
    DWK -->|"D10"| SHL
    SHL -->|"🚴 before 10AM"| WFH_M
    WFH_M -->|"🚴 back < 10AM"| SHL
    SHL -->|"🚶 after 6PM"| WFH_E
    WFH_E -->|"🚶 back to hotel"| SHL
    SHL -->|"D15"| KRS
    KRS -->|"D15"| DWK
    DWK -->|"D16"| GHY
    GHY -->|"D17"| TEZ
    ...
    GHY -.->|"⚡ D17"| POB(["⚡ Pobitora WLS\nAssam"])
    SHL -.->|"⚡ swap D13 AM ride"| MWP(["⚡ Mawphlang Forest\nMeghalaya"])
    SHL -.->|"⚡ D5 afternoon"| MRK(["⚡ Mawryngkhang\nBamboo Trek · Meghalaya"])
    ...
    %% ══ ➕ EXTENSIONS — extra days needed ══════════════════════════
    SIL -.->|"➕ +1–2d"| ZUL(["➕ Zuluk · Silk Route\nSikkim"])
    ...
    classDef transit  fill:#cbd5e1,stroke:#94a3b8,color:#1e293b
    classDef wfh_ride fill:#fed7aa,stroke:#ea580c,color:#7c2d12
    classDef wfh_walk fill:#ddd6fe,stroke:#7c3aed,color:#2e1065
    ...
    class MWL,KRS,JOR,NIM transit
    class WFH_M wfh_ride
    class WFH_E wfh_walk
    class JLD,POB,MWP,KYN,NAR,THB,GNK,ZEM,DIG,MRK opt
    class ZUL,MAN ext

    style SHL fill:#fb923c,stroke:#ea580c,color:#fff
    style DWK fill:#a855f7,stroke:#7e22ce,color:#fff
    style ANI fill:#ef4444,stroke:#b91c1c,color:#fff
```

**Legend:** 🟢 West Bengal &nbsp;·&nbsp; 🔵 Assam &nbsp;·&nbsp; 🟣 Meghalaya &nbsp;·&nbsp; 🔴 Arunachal Pradesh &nbsp;·&nbsp; 🟠 WFH base (Shillong) &nbsp;·&nbsp; ⬜ Transit stop &nbsp;·&nbsp; 🟧 🚴 WFH morning rides &nbsp;·&nbsp; 🟦 🚶 WFH evening walks &nbsp;·&nbsp; 🟡 ⚡ Optional &nbsp;·&nbsp; ░ ➕ Extension




<details>
<summary> 🗺️ **[Open Full Route on Google Maps →](https://www.google.com/maps/dir/Kolkata,+West+Bengal/Siliguri,+West+Bengal/Guwahati,+Assam/Shillong,+Meghalaya/Cherrapunji,+Meghalaya/Dawki,+Meghalaya/Tezpur,+Assam/Bomdila,+Arunachal+Pradesh/Tawang,+Arunachal+Pradesh/Kaziranga+National+Park,+Assam/Jorhat,+Assam/Majuli,+Assam/Sivasagar,+Assam/Dibrugarh,+Assam/Roing,+Arunachal+Pradesh/Anini,+Arunachal+Pradesh/)** — 16 stops across West Bengal · Assam · Meghalaya · Arunachal Pradesh · ~5,500 km</summary>
<iframe
  src="https://maps.google.com/maps?saddr=Kolkata,+West+Bengal&daddr=Siliguri,+West+Bengal+to:Guwahati,+Assam+to:Shillong,+Meghalaya+to:Cherrapunji,+Meghalaya+to:Dawki,+Meghalaya+to:Tezpur,+Assam+to:Bomdila,+Arunachal+Pradesh+to:Tawang,+Arunachal+Pradesh+to:Kaziranga+National+Park,+Assam+to:Jorhat,+Assam+to:Majuli,+Assam+to:Sivasagar,+Assam+to:Dibrugarh,+Assam+to:Roing,+Arunachal+Pradesh+to:Anini,+Arunachal+Pradesh&output=embed"
  width="100%"
  height="900"
...
> **Offbeat alternative afternoon — choose one:**
>
> **Option A — <PlaceLink name="Mawphlang Sacred Forest" state="Meghalaya" />** (25 km from Shillong) — a 400-year-old Khasi sacred grove (*Law Lyngdoh*) where tribal custom forbids removing anything: not a leaf, not a stone, not a berry. The forest has been protected this way for centuries — by taboo, not by government. A custodian clan called the *nongkynmaw* guides you through. Biodiversity inside the grove vs. outside its boundary is visibly, startlingly different. Entry with guide ₹200–300. Allow 2 hours minimum.
>
> **Option B — <PlaceLink name="Mawryngkhang Bamboo Trek" state="Meghalaya" />** (Wahkhen village, 45 km from Shillong via Pynursla hairpin road — perfect for the Scram 440). Bamboo bridges built by the local Khasi community along cliff faces above the **<PlaceLink name="Wahrew River" state="Meghalaya" />** gorge. This is not a viewpoint walk — it is a physically demanding cliff traverse with vertiginous drops on both sides, narrow bamboo plank paths, and steep ladders. 3.5 km round trip, 3–4 hrs. Trail open 9AM–5PM. **Logistics:** leave Shillong at 12:30 PM, reach Wahkhen by 2 PM, complete trek by 5 PM, back in Shillong by 6:30 PM. Entry ₹100. Distance from Dawki: 35 km — can also be done en route to Dawki on Day 9 if you skip Mawlynnong.
>
> If doing either option, save **Laitlum Canyon** for the WFH Day 14 morning ride instead (24 km, fits the pre-10AM window perfectly).
...
| ⚡ | <PlaceLink name="Mawryngkhang Bamboo Trek" state="Meghalaya" /> | 860m | 18–23°C | Bamboo bridges built by Khasi villagers along cliff faces above the <PlaceLink name="Wahrew River" state="Meghalaya" /> gorge. Vertiginous traverse — not a viewpoint walk. 3.5 km round trip, 3–4 hrs, trail 9AM–5PM. 45 km from Shillong via Pynursla hairpin road (ideal for Scram 440). Also 35 km from Dawki — possible Day 9 stop if skipping Mawlynnong. | Entry ₹100. **Day 5 afternoon** — replace Laitlum Canyon (save that for WFH D14 morning). Back in Shillong by 6:30PM. |
