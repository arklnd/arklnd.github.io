...
**Key stops:** <PlaceLink name="Shillong" /> · <PlaceLink name="Cherrapunji" /> · <PlaceLink name="Dawki" /> · <PlaceLink name="Sela Pass" /> (4,170m) · <PlaceLink name="Tawang" /> · <PlaceLink name="Kaziranga" /> · <PlaceLink name="Majuli" /> · <PlaceLink name="Anini" />
...
### Day 1 — <PlaceLink name="Kolkata" /> *(West Bengal)* → <PlaceLink name="Siliguri" /> *(West Bengal)*
...
### Day 2 — <PlaceLink name="Siliguri" /> *(West Bengal)* → <PlaceLink name="Guwahati" /> *(Assam)*
...
### Day 3 — <PlaceLink name="Guwahati" /> *(Assam)* — City Exploration
...
- **7:00 AM:** <PlaceLink name="Kamakhya Temple" />. One of 51 Shakti Peethas, Nilachal Hill. Go early for shorter queue. Allow 2 hours.
- **10:00 AM:** <PlaceLink name="Umananda Island" /> — ferry from Kachari Ghat (15 min). Shiva temple, golden langur monkeys.
...
### Day 4 — <PlaceLink name="Guwahati" /> *(Assam)* → <PlaceLink name="Shillong" /> *(Meghalaya)*
...
- **10:00 AM:** **<PlaceLink name="Umiam Lake" /> (Barapani)** — 15 km before Shillong. Pine-forested reservoir, stunning viewpoint. 30 min stop.
...
### Day 5 — <PlaceLink name="Shillong" /> *(Meghalaya)* — Full Day Exploration

- **6:30 AM:** **<PlaceLink name="Shillong Peak" />** (1,965m) — highest point in the city. Narrow bike road to the IAF-controlled summit viewpoint. Panoramic views before the morning cloud rolls in.
- **9:00 AM:** **<PlaceLink name="Elephant Falls" />** (12 km) — three-tier waterfall, well-maintained steps. Entry ₹20.
- **11:00 AM:** **<PlaceLink name="Don Bosco Museum" />** — 7 floors on NE India cultures. Best museum in the region. Allow 2 hours.
- **2:00 PM:** Lunch near Police Bazaar. Smoked pork with sticky rice.
- **4:00 PM:** **<PlaceLink name="Laitlum Canyon" />** (24 km) — "End of the Hills." Deep V-shaped valleys, cloud-wrapped ridges, small cliff villages. Sunset here is extraordinary.

---

### Day 6 — <PlaceLink name="Shillong" /> *(Meghalaya)* → <PlaceLink name="Cherrapunji/Sohra" /> *(Meghalaya)*
...
- **9:00 AM:** **<PlaceLink name="Mawkdok Dympep Valley" />** — gorge disappears below you, clouds below the cliff edge. 20 min stop.
...
- **12:00 PM:** **<PlaceLink name="Nohkalikai Falls" />** (340m drop, tallest plunge waterfall in India). Walk to the cliff edge.
- **1:30 PM:** **<PlaceLink name="Seven Sisters Falls" />** — 7 streams down the same limestone cliff. Entry ₹20.
- **3:00 PM:** **<PlaceLink name="Eco Park" />** — cliff-edge park overlooking Bangladesh plains and waterfalls.
- **4:30 PM:** **<PlaceLink name="Mawsmai Cave" />** — 150m lit limestone cave. Entry ₹20.
- **Dinner:** Orange Roots or Jiva Grill in Sohra.

---

### Day 7 — <PlaceLink name="Cherrapunji" /> *(Meghalaya)* — Waterfalls & Caves

- **7:00 AM:** **<PlaceLink name="Wei Sawdong Falls" />** — 3-tier hidden waterfall, 30-min forest trek. Aquamarine pools. Swim if warm enough. Start early.
- **10:00 AM:** Breakfast, then **<PlaceLink name="Arwah Cave" />** — fossil-embedded limestone passages, 65–70 million year old marine fossils. Entry ₹30.
- **1:00 PM:** Lunch at guesthouse.
- **2:30 PM:** **<PlaceLink name="Garden of Caves" />** — caves + waterfalls trail in the gorge. Entry ₹20.
- **4:00 PM:** **<PlaceLink name="Dainthlen Falls" />** — rocky gorge waterfall with a Khasi serpent legend. Short walk from road.
...
### Day 8 — <PlaceLink name="Double Decker Root Bridge" /> Trek *(<PlaceLink name="Cherrapunji" />, Meghalaya)*

**Full day off — most physically demanding day**

- **6:00 AM:** Drive 20 km to <PlaceLink name="Tyrna village" />. Park bike safely.
- **6:30 AM:** Descend 3,500 stone steps through jungle. Dense rainforest, suspension bridges over streams.
- **9:00 AM:** **<PlaceLink name="Single Root Bridge" />** en route. Rubber fig roots trained across a stream, load-bearing after generations of growth.
- **10:45 AM:** **<PlaceLink name="Double Decker Living Root Bridge" />**, Nongriat village. Two bridges stacked, the upper one 150+ years old. Walk across. Entry ₹50.
...
### Day 9 — <PlaceLink name="Cherrapunji" /> *(Meghalaya)* → <PlaceLink name="Mawlynnong" /> *(Meghalaya)* → <PlaceLink name="Dawki" /> *(Meghalaya)*
...
- **10:30 AM:** **<PlaceLink name="Mawlynnong Village" />** — Asia's cleanest village (awarded 2003). Walk the bamboo-dustbin streets, visit **<PlaceLink name="Riwai Living Root Bridge" />** (5-min walk), climb the **bamboo skywalk** for Bangladesh views. Entry ₹20.
...
- **3:00 PM:** Arrive **<PlaceLink name="Shnongpdeng" /> / <PlaceLink name="Dawki" />**. Check in at riverside camp or Dawki town homestay.
...
### Days 10–12 — WFH from <PlaceLink name="Dawki" /> *(Meghalaya)*
...
- **Day 11:** Half-day off for **<PlaceLink name="Krang Suri Falls" />** (80 km, 1.5 hrs each way). Turquoise waterfall pool, entry ₹50. Go weekday morning for no crowds.
...
### Day 13 — <PlaceLink name="Dawki" /> *(Meghalaya)* → <PlaceLink name="Guwahati" /> *(Assam)*
...
- **9:00 AM:** **<PlaceLink name="Phe Phe Falls" />** optional detour near Amlarem — hidden 3-tier falls through jungle walk. Worth it if not previously visited.
- **11:00 AM:** <PlaceLink name="Jowai" /> (West Jaintia Hills HQ) — **fuel stop.** 30-min market explore.
...
### Day 14 — <PlaceLink name="Guwahati" /> *(Assam)* → <PlaceLink name="Tezpur" /> *(Assam)*
...
- **2:30 PM:** **<PlaceLink name="Agnigarh Hill" />** — hilltop with Brahmaputra valley views and Mahabharata legend (Usha and Aniruddha).
- **3:30 PM:** **<PlaceLink name="Da Parbatia ruins" />** — 5th-century Gupta-period temple doorway. One of the oldest sculptural pieces in Assam.
- **5:30 PM:** **<PlaceLink name="Nameri National Park" />** vicinity (15 km away). Buffer zone birdwatching at dusk.
- **Evening:** Check in at Hotel Luit or Hotel Sripuria.

---

### Day 15 — <PlaceLink name="Tezpur" /> *(Assam)* → <PlaceLink name="Dirang" /> *(Arunachal Pradesh)*
...
- **8:30 AM:** **<PlaceLink name="Bhalukpong" />** — ILP check. **Fill fuel here.** Kameng River flows alongside.
- **10:00 AM – 12:00 PM:** Climb through Arunachal foothills. Road cut into hillside, increasingly dramatic views.
- **12:00 PM:** **<PlaceLink name="Bomdila" />** (2,415m) — **fill fuel.** Three monasteries here (visit Upper or Middle Gontse Gang, 30 min). Apple orchards in season.
- **2:00 PM:** Lunch in Bomdila market. Momos, thukpa, pork.
- **3:30 PM:** Continue to **<PlaceLink name="Dirang" />** (1,450m). Valley descent into the Dirang Chu river valley.
- **5:00 PM:** Arrive Dirang. Check in.
- **5:30 PM:** **<PlaceLink name="Dirang Hot Spring" />** (2 km from town) — sulphurous natural hot water spring.
- **Evening:** Walk to **<PlaceLink name="Dirang Dzong" />** — old stone fort village. Traditional Monpa stone-and-timber construction.

---

### Day 16 — <PlaceLink name="Dirang" /> *(Arunachal Pradesh)* → <PlaceLink name="Sela Pass" /> → <PlaceLink name="Tawang" /> *(Arunachal Pradesh)*
...
- **7:30 AM:** **<PlaceLink name="Sangti Valley" />** (12 km from Dirang) — open flat valley, black-necked cranes in winter (Oct–Mar). Brief stop.
- **9:00 AM:** Road begins aggressive climb toward Sela.
- **10:30 AM:** **<PlaceLink name="Sela Pass" />** (4,170m / 13,680 ft). Summit marked by prayer flags and Sela Lake.
  - **<PlaceLink name="Sela Lake" />:** Large alpine lake beside the road, often partially iced from late October.
...
- **12:30 PM:** **<PlaceLink name="Jaswant Garh War Memorial" />** — memorial to Jaswant Singh Rawat who held his position here in 1962. The army maintains his room as if he is still on duty.
- **1:00 PM:** **<PlaceLink name="Jang town" />** — lunch. Simple momo + rice restaurants.
- **1:30 PM:** **<PlaceLink name="Nuranang Falls" /> (Jang Falls)** — 2 km east of Jang. Named after Noora, the second Monpa girl from the 1962 story. Wide curtain waterfall over a rocky gorge.
...
### Day 17 — <PlaceLink name="Tawang" /> *(Arunachal Pradesh)* — Monastery & Memorials

- **7:00 AM:** **<PlaceLink name="Tawang Monastery" /> (Galden Namgey Lhatse)** — largest in India, 2nd largest in the world after Potala (Lhasa). Founded 1681. Houses 500 monks. 8m gold-painted Buddha in the main hall. 400-year-old manuscripts in the library. Allow 2–3 hours. Go early for empty courtyards.
- **10:00 AM:** **<PlaceLink name="Urgelling Monastery" />** — birthplace of the 6th Dalai Lama. Smaller, quieter, more intimate.
- **12:00 PM:** **<PlaceLink name="Tawang War Memorial" />** — 2,420 Indian soldiers of the 1962 war. Inscribed names on the walls. Sound and light show at dusk.
- **2:00 PM:** Lunch in Tawang market.
- **3:30 PM:** **<PlaceLink name="PT Tso Lake" /> (Pankang Teng Tso)** — 17 km from Tawang, ~4,000m. Alpine lake, army road. Carry ILP.
- **Evening:** Sound & Light show at the War Memorial at dusk.

---

### Day 18 — <PlaceLink name="Tawang" /> *(Arunachal Pradesh)* — <PlaceLink name="Madhuri Lake" /> & <PlaceLink name="Bum La Pass" />

**Two options depending on permit status:**

**If Bum La permit received:**
- **6:00 AM:** Depart with registered guide to **<PlaceLink name="Bum La Pass" />** (4,793m, India-China border). 40 km rough military road. Chinese bunkers visible 200m across the LAC. Indian Army personnel at the gate.
...
**If no Bum La permit:**
- **8:00 AM:** Ride to **<PlaceLink name="Madhuri Lake" /> (Sangetsar Tso)**. Two hours riding each way on mountain roads.
- **Midday:** At the lake. Silent, cold, high. One of the most beautiful places on this entire journey.
- **Afternoon:** Optional: **<PlaceLink name="Zemithang valley" />** (80 km from Tawang, remote Monpa villages near Bhutan border).

---

### Day 19 — <PlaceLink name="Tawang" /> *(Arunachal Pradesh)* → <PlaceLink name="Bomdila" /> *(Arunachal Pradesh)* — Return
...
### Day 20 — <PlaceLink name="Bomdila" /> *(Arunachal Pradesh)* → <PlaceLink name="Kaziranga" /> *(Assam)*
...
### Day 21 — <PlaceLink name="Kaziranga National Park" /> *(Assam)*
...
### Day 22 — <PlaceLink name="Kaziranga" /> *(Assam)* → <PlaceLink name="Majuli Island" /> *(Assam)*

**Distance:** ~95 km to Nimatighat + ferry | **Riding:** 2 hours + ferry

- **8:00 AM:** Ride east on NH27 to Jorhat (100 km).
- **10:00 AM:** Continue to **<PlaceLink name="Nimatighat" />** (17 km from Jorhat).
- **12:00 PM:** Board ferry to **<PlaceLink name="Majuli" />** — world's largest river island. Bike loaded onto flat-bottomed ferry. 1–1.5 hr crossing. The Brahmaputra at this point is overwhelming in scale.
- **1:30 PM:** Land on Majuli. Check in at a guesthouse in Garamur or Kamalabari.
- **2:30 PM:** **<PlaceLink name="Kamalabari Satra" />** — Vaishnavite monastery, Sattriya dance practice, ancient masked dance props.
...
### Day 23 — <PlaceLink name="Majuli" /> *(Assam)* → <PlaceLink name="Jorhat" /> → <PlaceLink name="Dibrugarh" /> *(Assam)*

**Distance (Jorhat → Dibrugarh):** 55 km | **Riding:** 1.5 hours

- **7:00 AM:** Sunrise over the Brahmaputra from any riverbank.
- **9:00 AM:** **<PlaceLink name="Auniati Satra" />** — largest satra on Majuli, museum of Ahom-era artefacts, royal jewellery, manuscripts.
...
### Day 24 — <PlaceLink name="Dibrugarh" /> *(Assam)* → <PlaceLink name="Roing" /> *(Arunachal Pradesh)*
...
- **7:00 AM:** Depart Dibrugarh. Cross **<PlaceLink name="Bogibeel Bridge" />** over the Brahmaputra (the bridge is an engineering marvel — 4.94 km, opened 2018, strategic military route).
...
- **2:00 PM:** **<PlaceLink name="Mehao Lake" />** (25 km from Roing) — beautiful forest lake in Mehao Wildlife Sanctuary. Gayal, tigers, rare birds.
...
### Day 25 — <PlaceLink name="Roing" /> *(Arunachal Pradesh)* → <PlaceLink name="Anini" /> *(Arunachal Pradesh)*
...
- **8:00 AM:** **<PlaceLink name="Hunli" />** (~100 km) — last small settlement. Ask about road conditions ahead. Basic food if available. **Fill fuel here if a pump exists** (don't count on it — ask in Roing the night before).
...
### Day 26 — <PlaceLink name="Anini" /> *(Arunachal Pradesh)* — Exploration
...
- **7:00 AM:** Walk to the **<PlaceLink name="Dri River" />** — glacier-fed, milky blue, roaring. Traditional **cane bridges** span it at certain points — some centuries old, still functional.
...
- **2:00 PM:** Walk north toward **<PlaceLink name="Dibang Wildlife Sanctuary" />** boundary. Red panda, Mishmi takin, musk deer, Asiatic black bear inhabit the sanctuary. Birdlife: Sclater's monal (one of the rarest pheasants in the world), Blyth's tragopan. You won't see large animals on a casual walk, but the habitat is extraordinary.
- **Evening:** Sit at the edge of the plateau. Mountains rising to 5,000m on every side. No noise. This is why you came.

---

### Day 27 — <PlaceLink name="Anini" /> *(Arunachal Pradesh)* → <PlaceLink name="Roing" /> → <PlaceLink name="Dibrugarh" /> *(Assam)*
...
### Day 28 — <PlaceLink name="Dibrugarh" /> *(Assam)* → <PlaceLink name="Guwahati" /> *(Assam)*
...
- **7:30 AM:** <PlaceLink name="Jorhat" /> (~55 km) — tea stop. The tea gardens line the road.
- **10:00 AM:** <PlaceLink name="Kaziranga" /> area (~150 km) — you already did the safaris on Day 21. Ride through without stopping, or pull over briefly at the highway boundary for a last look.
- **1:00 PM:** <PlaceLink name="Nagaon" /> (~350 km) — **fill fuel.** Lunch at a dhaba. Rice, dal, fried river fish.
- **5:30 PM:** Arrive <PlaceLink name="Guwahati" />. Check in near Paltan Bazaar. Hot shower. The city feels enormous after Anini.
- **Evening:** Last Assam meal — pork with bamboo shoot, khar fish curry, or duck in mustard. Fancy Bazar area has everything.

---

### Day 29 — <PlaceLink name="Guwahati" /> *(Assam)* → <PlaceLink name="Siliguri" /> *(West Bengal)*
...
- **9:00 AM:** <PlaceLink name="Bongaigaon" /> (~200 km) — **fill fuel.** Tea break.
...
### Day 30 — <PlaceLink name="Siliguri" /> *(West Bengal)* → <PlaceLink name="Kolkata" /> *(West Bengal)*
