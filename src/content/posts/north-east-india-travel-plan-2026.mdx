...
<div style="border-left:4px solid #8b5cf6;background:rgba(139,92,246,0.08);padding:0.65rem 1rem;margin:1rem 0;border-radius:0 6px 6px 0">
  <strong>🦏 Optional Early Morning: Pobitora Wildlife Sanctuary</strong><br/>
  53 km east of Guwahati on NH37. Has the world's highest density of Indian one-horned rhinos per km² — more concentrated than Kaziranga per unit area. The 38 km² park is intimate; rhinos graze 20m from the jeep. Also excellent for Bengal florican (critically endangered) and migratory ducks in October. <strong>Jeep safari:</strong> 2 hrs, entry ₹50, jeep ~₹800. <strong>How:</strong> Depart Guwahati at 5:30 AM → morning safari at Pobitora → back on highway by 10 AM → arrive Tezpur by 1:30 PM. Adds ~2 hours to the day. Even if you're doing Kaziranga later (Day 24), Pobitora is a different, far more intimate experience.
</div>
...
<div style="border-left:4px solid #ef4444;background:rgba(239,68,68,0.08);padding:0.65rem 1rem;margin:1rem 0;border-radius:0 6px 6px 0">
  <strong>🐯 Major Optional Extension: Manas National Park (UNESCO World Heritage Site)</strong><br/>
  Manas is conspicuously absent from most NE itineraries, including this one. It is simultaneously a UNESCO WHS, Tiger Reserve, Elephant Reserve, and Biosphere Reserve — one of only two sites in India with all four designations (the other is Sundarbans). It has the golden langur (found almost nowhere else on Earth), pygmy hog (world's smallest pig, critically endangered), hispid hare, and the same big-game as Kaziranga but in dense Himalayan foothills forest and river gorge — a completely different ecosystem from Kaziranga's grassland. <br/><br/>
  Park gate (Bhuiyanpara/Bansbari range): ~125 km west of Tezpur, ~200 km from Guwahati. <strong>How to include without losing too much time:</strong> Day 17 — Guwahati → Manas (200 km, overnight at Bansbari Lodge). Day 18 — morning safari at Manas (golden langur sighting probability: high in October) → depart for Tezpur (125 km) by noon → push to Bhalukpong entry same evening. This requires 1 extra leave day and pushes everything by 1 day, but Manas is a wildlife experience that Kaziranga doesn't replicate.
</div>
...
<div style="border-left:4px solid #ef4444;background:rgba(239,68,68,0.08);padding:0.65rem 1rem;margin:1rem 0;border-radius:0 6px 6px 0">
  <strong>⚠️ Critical stop: Sivasagar (Sibsagar) — Ahom Dynasty Capital</strong><br/>
  Sivasagar is 60 km from Jorhat on NH37 toward Dibrugarh — it is literally on your road home. Not stopping here would be like riding past Hampi and not looking. The Ahom kingdom ruled Assam for 600 years (1228–1826 AD) and never fell to the Mughals. These are their monuments:
</div>
...
<div style="border-left:4px solid #8b5cf6;background:rgba(139,92,246,0.08);padding:0.65rem 1rem;margin:1rem 0;border-radius:0 6px 6px 0">
  <strong>🛢️ Optional Morning: Digboi — Asia's Oldest Oil Refinery + WWII History</strong><br/>
  70 km northeast of Dibrugarh (1 hr on NH37 toward Tinsukia then branch off). <strong>Digboi</strong> has the world's oldest continuously-operating oil well (drilled 1889, still producing) and a refinery that has run without interruption since. The town feels frozen in a British colonial time capsule — teak bungalows, wide avenues, the smell of crude, a cricket ground from 1895. Visit the <strong>Digboi Oil Museum</strong> (well-maintained, unusual exhibits), walk past the original well, and see the WWII War Cemetery (Assam–Burma campaign, 1944). Combine with <strong>Dehing Patkai Wildlife Sanctuary</strong> near Margherita (90 km from Dibrugarh) — India's last lowland rainforest east of the Brahmaputra, home to Hoolock gibbons. If doing this, depart Dibrugarh at 6 AM, return by 11 AM, then depart for Roing.
</div>
